...
public class ja_unarc_xz extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_xz(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unxz(
		...
		try{
			...
			org.apache.commons.compress.compressors.xz.XZCompressorInputStream xzis=new org.apache.commons.compress.compressors.xz.XZCompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,xzis);
