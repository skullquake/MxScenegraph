...
public class ja_unarc_deflate64 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_deflate64(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	{
		return "ja_unarc_deflate64";
	}

	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> undeflate64(
		...
		try{
			...
			org.apache.commons.compress.compressors.deflate64.Deflate64CompressorInputStream deflate64is=new org.apache.commons.compress.compressors.deflate64.Deflate64CompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,deflate64is);
