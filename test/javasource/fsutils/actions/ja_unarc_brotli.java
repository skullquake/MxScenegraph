...
public class ja_unarc_brotli extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_brotli(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		// BEGIN USER CODE
		return this.unbrotli(
				obj_src.getMendixObject(),
				this.getContext(),
				this.bool_txn==null?true:this.bool_txn,
				this.str_type==null?"System.FileDocument":this.str_type
		);
		// END USER CODE
	}
	...
	{
		return "ja_unarc_brotli";
	}

	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unbrotli(
		...
		try{
			...
			org.apache.commons.compress.compressors.brotli.BrotliCompressorInputStream brotliis=new org.apache.commons.compress.compressors.brotli.BrotliCompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,brotliis);
