...
public class ja_unarc_z extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_z(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unz(
		...
		java.util.List ret=new java.util.ArrayList<com.mendix.systemwideinterfaces.core.IMendixObject>();
		...
		try{
			...
			org.apache.commons.compress.compressors.z.ZCompressorInputStream zis=new org.apache.commons.compress.compressors.z.ZCompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,zis);
