...
public class ja_unarc_snappy extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_snappy(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	{
		return "ja_unarc_snappy";
	}

	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unsnappy(
		...
		try{
			...
			org.apache.commons.compress.compressors.snappy.SnappyCompressorInputStream snappyis=new org.apache.commons.compress.compressors.snappy.SnappyCompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,snappyis);
