...
public class ja_unarc_lzma extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_lzma(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	{
		return "ja_unarc_lzma";
	}

	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unlzma(
		...
		try{
			...
			org.apache.commons.compress.compressors.lzma.LZMACompressorInputStream lzmais=new org.apache.commons.compress.compressors.lzma.LZMACompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,lzmais);
