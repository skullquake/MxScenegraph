...
public class ja_arc_unixdump extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject __obj_src;
	private system.proxies.FileDocument obj_src;

	public ja_arc_unixdump(IContext context, IMendixObject obj_src)
	{
		super(context);
