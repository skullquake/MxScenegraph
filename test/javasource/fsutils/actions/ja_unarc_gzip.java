...
public class ja_unarc_gzip extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_gzip(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	{
		return "ja_unarc_gzip";
	}

	// BEGIN EXTRA CODE
        private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> ungzip(
		...
		try{
			...
			org.apache.commons.compress.compressors.gzip.GzipCompressorInputStream gzInputStream=new org.apache.commons.compress.compressors.gzip.GzipCompressorInputStream(is);
			try{
				...
				com.mendix.core.Core.storeFileDocumentContent(_ctx,o,gzInputStream);
