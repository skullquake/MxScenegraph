...
public class ja_unarc_bzip2 extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject __obj_src;
	private system.proxies.FileDocument obj_src;

	public ja_unarc_bzip2(IContext context, IMendixObject obj_src)
	{
		super(context);
