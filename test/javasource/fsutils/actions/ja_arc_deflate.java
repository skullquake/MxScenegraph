...
public class ja_arc_deflate extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject __obj_src;
	private system.proxies.FileDocument obj_src;

	public ja_arc_deflate(IContext context, IMendixObject obj_src)
	{
		super(context);
