...
public class ja_unarc_pack200 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ja_unarc_pack200(IContext context, IMendixObject obj_src, java.lang.String str_type, java.lang.Boolean bool_txn)
	{
		super(context);
	...
	{
		return "ja_unarc_pack200";
	}

	// BEGIN EXTRA CODE
	private java.util.List<com.mendix.systemwideinterfaces.core.IMendixObject> unpack200(
		...
		try{
			...
			org.apache.commons.compress.compressors.pack200.Pack200CompressorInputStream pack200is=new org.apache.commons.compress.compressors.pack200.Pack200CompressorInputStream(is);
			...
			com.mendix.core.Core.storeFileDocumentContent(_ctx,o,pack200is);
